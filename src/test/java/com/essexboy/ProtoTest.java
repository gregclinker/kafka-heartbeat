...
public class ProtoTest {
    ...
    /*
    7:46:55.915 [main] DEBUG com.essexboy.HeartBeatConfig - created config HeartBeatConfig(numberOfBrokers=3, interval=10, standardIsr=2, reducedIsr=1, countToSwitch=3, kafkaProperties={security.protocol=SSL, ssl.truststore.location=/home/greg/work/kafka-heartbeat/secrets/kafka_truststore.jks, ssl.keystore.password=confluent, ssl.key.password=confluent, ssl.keystore.location=/home/greg/work/kafka-heartbeat/secrets/kafka_keystore.jks, bootstrap.servers=172.19.0.6:29092,172.19.0.7:29093,172.19.0.8:29094,172.19.0.5:29095,172.19.0.9:29096,172.19.0.10:29097, ssl.truststore.password=confluent, ssl.endpoint.identification.algorithm= }, topics=[greg-test1, greg-test2], switchMinIsrDelay=1)
TopicInfo{name='greg-test10', partitions=[PartitionInfo(id=0, leader=3, replicas=[1, 2, 3, 4, 5, 6], isrs=[1, 2, 3, 4, 5, 6]), PartitionInfo(id=1, leader=6, replicas=[1, 2, 3, 4, 5, 6], isrs=[1, 2, 3, 4, 5, 6]), PartitionInfo(id=2, leader=1, replicas=[1, 2, 3, 4, 5, 6], isrs=[1, 2, 3, 4, 5, 6]), PartitionInfo(id=3, leader=4, replicas=[1, 2, 3, 4, 5, 6], isrs=[1, 2, 3, 4, 5, 6]), PartitionInfo(id=4, leader=2, replicas=[1, 2, 3, 4, 5, 6], isrs=[1, 2, 3, 4, 5, 6]), PartitionInfo(id=5, leader=5, replicas=[1, 2, 3, 4, 5, 6], isrs=[1, 2, 3, 4, 5, 6]), PartitionInfo(id=6, leader=3, replicas=[1, 2, 3, 4, 5, 6], isrs=[1, 2, 3, 4, 5, 6]), PartitionInfo(id=7, leader=6, replicas=[1, 2, 3, 4, 5, 6], isrs=[1, 2, 3, 4, 5, 6]), PartitionInfo(id=8, leader=1, replicas=[1, 2, 3, 4, 5, 6], isrs=[1, 2, 3, 4, 5, 6]), PartitionInfo(id=9, leader=4, replicas=[1, 2, 3, 4, 5, 6], isrs=[1, 2, 3, 4, 5, 6]), PartitionInfo(id=10, leader=2, replicas=[1, 2, 3, 4, 5, 6], isrs=[1, 2, 3, 4, 5, 6]), PartitionInfo(id=11, leader=5, replicas=[1, 2, 3, 4, 5, 6], isrs=[1, 2, 3, 4, 5, 6]), PartitionInfo(id=12, leader=3, replicas=[1, 2, 3, 4, 5, 6], isrs=[1, 2, 3, 4, 5, 6]), PartitionInfo(id=13, leader=6, replicas=[1, 2, 3, 4, 5, 6], isrs=[1, 2, 3, 4, 5, 6]), PartitionInfo(id=14, leader=1, replicas=[1, 2, 3, 4, 5, 6], isrs=[1, 2, 3, 4, 5, 6]), PartitionInfo(id=15, leader=4, replicas=[1, 2, 3, 4, 5, 6], isrs=[1, 2, 3, 4, 5, 6]), PartitionInfo(id=16, leader=2, replicas=[1, 2, 3, 4, 5, 6], isrs=[1, 2, 3, 4, 5, 6]), PartitionInfo(id=17, leader=5, replicas=[1, 2, 3, 4, 5, 6], isrs=[1, 2, 3, 4, 5, 6]), PartitionInfo(id=18, leader=3, replicas=[1, 2, 3, 4, 5, 6], isrs=[1, 2, 3, 4, 5, 6]), PartitionInfo(id=19, leader=6, replicas=[1, 2, 3, 4, 5, 6], isrs=[1, 2, 3, 4, 5, 6]), PartitionInfo(id=20, leader=1, replicas=[1, 2, 3, 4, 5, 6], isrs=[1, 2, 3, 4, 5, 6]), PartitionInfo(id=21, leader=4, replicas=[1, 2, 3, 4, 5, 6], isrs=[1, 2, 3, 4, 5, 6]), PartitionInfo(id=22, leader=2, replicas=[1, 2, 3, 4, 5, 6], isrs=[1, 2, 3, 4, 5, 6]), PartitionInfo(id=23, leader=5, replicas=[1, 2, 3, 4, 5, 6], isrs=[1, 2, 3, 4, 5, 6])]}
TopicInfo{name='greg-test1', partitions=[PartitionInfo(id=0, leader=2, replicas=[2, 3, 5, 6], isrs=[2, 3, 5, 6]), PartitionInfo(id=1, leader=5, replicas=[1, 3, 5, 6], isrs=[1, 3, 5, 6])]}
TopicInfo{name='greg-test4', partitions=[PartitionInfo(id=0, leader=5, replicas=[2, 3, 5, 6], isrs=[2, 3, 5, 6]), PartitionInfo(id=1, leader=3, replicas=[1, 3, 5, 6], isrs=[1, 3, 5, 6]), PartitionInfo(id=2, leader=6, replicas=[1, 3, 4, 6], isrs=[1, 3, 4, 6]), PartitionInfo(id=3, leader=1, replicas=[1, 2, 4, 6], isrs=[1, 2, 4, 6]), PartitionInfo(id=4, leader=4, replicas=[1, 2, 4, 5], isrs=[1, 2, 4, 5]), PartitionInfo(id=5, leader=2, replicas=[2, 3, 4, 5], isrs=[2, 3, 4, 5]), PartitionInfo(id=6, leader=5, replicas=[1, 2, 4, 5], isrs=[1, 2, 4, 5]), PartitionInfo(id=7, leader=3, replicas=[2, 3, 4, 5], isrs=[2, 3, 4, 5]), PartitionInfo(id=8, leader=6, replicas=[2, 3, 5, 6], isrs=[2, 3, 5, 6])]}
TopicInfo{name='greg-test5', partitions=[PartitionInfo(id=0, leader=5, replicas=[2, 5], isrs=[2, 5]), PartitionInfo(id=1, leader=3, replicas=[3, 5], isrs=[3, 5]), PartitionInfo(id=2, leader=6, replicas=[3, 6], isrs=[3, 6]), PartitionInfo(id=3, leader=1, replicas=[1, 6], isrs=[1, 6]), PartitionInfo(id=4, leader=4, replicas=[1, 4], isrs=[1, 4]), PartitionInfo(id=5, leader=2, replicas=[2, 4], isrs=[2, 4]), PartitionInfo(id=6, leader=5, replicas=[3, 5], isrs=[3, 5]), PartitionInfo(id=7, leader=3, replicas=[3, 6], isrs=[3, 6]), PartitionInfo(id=8, leader=6, replicas=[1, 6], isrs=[1, 6]), PartitionInfo(id=9, leader=1, replicas=[1, 4], isrs=[1, 4]), PartitionInfo(id=10, leader=4, replicas=[2, 4], isrs=[2, 4]), PartitionInfo(id=11, leader=2, replicas=[2, 5], isrs=[2, 5]), PartitionInfo(id=12, leader=5, replicas=[1, 5], isrs=[1, 5]), PartitionInfo(id=13, leader=3, replicas=[3, 4], isrs=[3, 4]), PartitionInfo(id=14, leader=6, replicas=[2, 6], isrs=[2, 6]), PartitionInfo(id=15, leader=1, replicas=[1, 5], isrs=[1, 5]), PartitionInfo(id=16, leader=4, replicas=[3, 4], isrs=[3, 4]), PartitionInfo(id=17, leader=2, replicas=[2, 6], isrs=[2, 6]), PartitionInfo(id=18, leader=5, replicas=[2, 5], isrs=[2, 5]), PartitionInfo(id=19, leader=3, replicas=[3, 5], isrs=[3, 5]), PartitionInfo(id=20, leader=6, replicas=[3, 6], isrs=[3, 6]), PartitionInfo(id=21, leader=1, replicas=[1, 6], isrs=[1, 6]), PartitionInfo(id=22, leader=4, replicas=[1, 4], isrs=[1, 4]), PartitionInfo(id=23, leader=2, replicas=[2, 4], isrs=[2, 4])]}
TopicInfo{name='greg-test2', partitions=[PartitionInfo(id=0, leader=6, replicas=[1, 3, 4, 6], isrs=[1, 3, 4, 6]), PartitionInfo(id=1, leader=1, replicas=[1, 2, 4, 6], isrs=[1, 2, 4, 6]), PartitionInfo(id=2, leader=4, replicas=[1, 2, 4, 5], isrs=[1, 2, 4, 5])]}
TopicInfo{name='greg-test3', partitions=[PartitionInfo(id=0, leader=5, replicas=[2, 3, 5, 6], isrs=[2, 3, 5, 6]), PartitionInfo(id=1, leader=3, replicas=[1, 3, 5, 6], isrs=[1, 3, 5, 6]), PartitionInfo(id=2, leader=6, replicas=[1, 3, 4, 6], isrs=[1, 3, 4, 6]), PartitionInfo(id=3, leader=1, replicas=[1, 2, 4, 6], isrs=[1, 2, 4, 6]), PartitionInfo(id=4, leader=4, replicas=[1, 2, 4, 5], isrs=[1, 2, 4, 5])]}
TopicInfo{name='greg-test8', partitions=[PartitionInfo(id=0, leader=3, replicas=[1, 3, 5, 6], isrs=[1, 3, 5, 6]), PartitionInfo(id=1, leader=6, replicas=[1, 3, 4, 6], isrs=[1, 3, 4, 6]), PartitionInfo(id=2, leader=1, replicas=[1, 2, 4, 6], isrs=[1, 2, 4, 6]), PartitionInfo(id=3, leader=4, replicas=[1, 2, 4, 5], isrs=[1, 2, 4, 5]), PartitionInfo(id=4, leader=2, replicas=[2, 3, 4, 5], isrs=[2, 3, 4, 5])]}
TopicInfo{name='greg-test9', partitions=[PartitionInfo(id=0, leader=6, replicas=[1, 2, 4, 6], isrs=[1, 2, 4, 6]), PartitionInfo(id=1, leader=1, replicas=[1, 2, 4, 5], isrs=[1, 2, 4, 5]), PartitionInfo(id=2, leader=4, replicas=[2, 3, 4, 5], isrs=[2, 3, 4, 5]), PartitionInfo(id=3, leader=2, replicas=[2, 3, 5, 6], isrs=[2, 3, 5, 6]), PartitionInfo(id=4, leader=5, replicas=[1, 3, 5, 6], isrs=[1, 3, 5, 6]), PartitionInfo(id=5, leader=3, replicas=[1, 3, 4, 6], isrs=[1, 3, 4, 6]), PartitionInfo(id=6, leader=6, replicas=[2, 3, 5, 6], isrs=[2, 3, 5, 6]), PartitionInfo(id=7, leader=1, replicas=[1, 3, 5, 6], isrs=[1, 3, 5, 6]), PartitionInfo(id=8, leader=4, replicas=[1, 3, 4, 6], isrs=[1, 3, 4, 6])]}
TopicInfo{name='greg-test6', partitions=[PartitionInfo(id=0, leader=3, replicas=[1, 3, 4, 6], isrs=[1, 3, 4, 6]), PartitionInfo(id=1, leader=6, replicas=[1, 2, 4, 6], isrs=[1, 2, 4, 6])]}
TopicInfo{name='greg-test7', partitions=[PartitionInfo(id=0, leader=5, replicas=[1, 2, 4, 5], isrs=[1, 2, 4, 5]), PartitionInfo(id=1, leader=3, replicas=[2, 3, 4, 5], isrs=[2, 3, 4, 5]), PartitionInfo(id=2, leader=6, replicas=[2, 3, 5, 6], isrs=[2, 3, 5, 6])]}
partitions with < 4 replicas
greg-test5
partitions with < 3 ISRs
[PartitionInfo(id=0, leader=5, replicas=[2, 5], isrs=[2, 5]), PartitionInfo(id=1, leader=3, replicas=[3, 5], isrs=[3, 5]), PartitionInfo(id=2, leader=6, replicas=[3, 6], isrs=[3, 6]), PartitionInfo(id=3, leader=1, replicas=[1, 6], isrs=[1, 6]), PartitionInfo(id=4, leader=4, replicas=[1, 4], isrs=[1, 4]), PartitionInfo(id=5, leader=2, replicas=[2, 4], isrs=[2, 4]), PartitionInfo(id=6, leader=5, replicas=[3, 5], isrs=[3, 5]), PartitionInfo(id=7, leader=3, replicas=[3, 6], isrs=[3, 6]), PartitionInfo(id=8, leader=6, replicas=[1, 6], isrs=[1, 6]), PartitionInfo(id=9, leader=1, replicas=[1, 4], isrs=[1, 4]), PartitionInfo(id=10, leader=4, replicas=[2, 4], isrs=[2, 4]), PartitionInfo(id=11, leader=2, replicas=[2, 5], isrs=[2, 5]), PartitionInfo(id=12, leader=5, replicas=[1, 5], isrs=[1, 5]), PartitionInfo(id=13, leader=3, replicas=[3, 4], isrs=[3, 4]), PartitionInfo(id=14, leader=6, replicas=[2, 6], isrs=[2, 6]), PartitionInfo(id=15, leader=1, replicas=[1, 5], isrs=[1, 5]), PartitionInfo(id=16, leader=4, replicas=[3, 4], isrs=[3, 4]), PartitionInfo(id=17, leader=2, replicas=[2, 6], isrs=[2, 6]), PartitionInfo(id=18, leader=5, replicas=[2, 5], isrs=[2, 5]), PartitionInfo(id=19, leader=3, replicas=[3, 5], isrs=[3, 5]), PartitionInfo(id=20, leader=6, replicas=[3, 6], isrs=[3, 6]), PartitionInfo(id=21, leader=1, replicas=[1, 6], isrs=[1, 6]), PartitionInfo(id=22, leader=4, replicas=[1, 4], isrs=[1, 4]), PartitionInfo(id=23, leader=2, replicas=[2, 4], isrs=[2, 4])]
partitions with < 5 replicas
[PartitionInfo(id=0, leader=2, replicas=[2, 3, 5, 6], isrs=[2, 3, 5, 6]), PartitionInfo(id=1, leader=5, replicas=[1, 3, 5, 6], isrs=[1, 3, 5, 6])]
[PartitionInfo(id=0, leader=5, replicas=[2, 3, 5, 6], isrs=[2, 3, 5, 6]), PartitionInfo(id=1, leader=3, replicas=[1, 3, 5, 6], isrs=[1, 3, 5, 6]), PartitionInfo(id=2, leader=6, replicas=[1, 3, 4, 6], isrs=[1, 3, 4, 6]), PartitionInfo(id=3, leader=1, replicas=[1, 2, 4, 6], isrs=[1, 2, 4, 6]), PartitionInfo(id=4, leader=4, replicas=[1, 2, 4, 5], isrs=[1, 2, 4, 5]), PartitionInfo(id=5, leader=2, replicas=[2, 3, 4, 5], isrs=[2, 3, 4, 5]), PartitionInfo(id=6, leader=5, replicas=[1, 2, 4, 5], isrs=[1, 2, 4, 5]), PartitionInfo(id=7, leader=3, replicas=[2, 3, 4, 5], isrs=[2, 3, 4, 5]), PartitionInfo(id=8, leader=6, replicas=[2, 3, 5, 6], isrs=[2, 3, 5, 6])]
[PartitionInfo(id=0, leader=5, replicas=[2, 5], isrs=[2, 5]), PartitionInfo(id=1, leader=3, replicas=[3, 5], isrs=[3, 5]), PartitionInfo(id=2, leader=6, replicas=[3, 6], isrs=[3, 6]), PartitionInfo(id=3, leader=1, replicas=[1, 6], isrs=[1, 6]), PartitionInfo(id=4, leader=4, replicas=[1, 4], isrs=[1, 4]), PartitionInfo(id=5, leader=2, replicas=[2, 4], isrs=[2, 4]), PartitionInfo(id=6, leader=5, replicas=[3, 5], isrs=[3, 5]), PartitionInfo(id=7, leader=3, replicas=[3, 6], isrs=[3, 6]), PartitionInfo(id=8, leader=6, replicas=[1, 6], isrs=[1, 6]), PartitionInfo(id=9, leader=1, replicas=[1, 4], isrs=[1, 4]), PartitionInfo(id=10, leader=4, replicas=[2, 4], isrs=[2, 4]), PartitionInfo(id=11, leader=2, replicas=[2, 5], isrs=[2, 5]), PartitionInfo(id=12, leader=5, replicas=[1, 5], isrs=[1, 5]), PartitionInfo(id=13, leader=3, replicas=[3, 4], isrs=[3, 4]), PartitionInfo(id=14, leader=6, replicas=[2, 6], isrs=[2, 6]), PartitionInfo(id=15, leader=1, replicas=[1, 5], isrs=[1, 5]), PartitionInfo(id=16, leader=4, replicas=[3, 4], isrs=[3, 4]), PartitionInfo(id=17, leader=2, replicas=[2, 6], isrs=[2, 6]), PartitionInfo(id=18, leader=5, replicas=[2, 5], isrs=[2, 5]), PartitionInfo(id=19, leader=3, replicas=[3, 5], isrs=[3, 5]), PartitionInfo(id=20, leader=6, replicas=[3, 6], isrs=[3, 6]), PartitionInfo(id=21, leader=1, replicas=[1, 6], isrs=[1, 6]), PartitionInfo(id=22, leader=4, replicas=[1, 4], isrs=[1, 4]), PartitionInfo(id=23, leader=2, replicas=[2, 4], isrs=[2, 4])]
[PartitionInfo(id=0, leader=6, replicas=[1, 3, 4, 6], isrs=[1, 3, 4, 6]), PartitionInfo(id=1, leader=1, replicas=[1, 2, 4, 6], isrs=[1, 2, 4, 6]), PartitionInfo(id=2, leader=4, replicas=[1, 2, 4, 5], isrs=[1, 2, 4, 5])]
[PartitionInfo(id=0, leader=5, replicas=[2, 3, 5, 6], isrs=[2, 3, 5, 6]), PartitionInfo(id=1, leader=3, replicas=[1, 3, 5, 6], isrs=[1, 3, 5, 6]), PartitionInfo(id=2, leader=6, replicas=[1, 3, 4, 6], isrs=[1, 3, 4, 6]), PartitionInfo(id=3, leader=1, replicas=[1, 2, 4, 6], isrs=[1, 2, 4, 6]), PartitionInfo(id=4, leader=4, replicas=[1, 2, 4, 5], isrs=[1, 2, 4, 5])]
[PartitionInfo(id=0, leader=3, replicas=[1, 3, 5, 6], isrs=[1, 3, 5, 6]), PartitionInfo(id=1, leader=6, replicas=[1, 3, 4, 6], isrs=[1, 3, 4, 6]), PartitionInfo(id=2, leader=1, replicas=[1, 2, 4, 6], isrs=[1, 2, 4, 6]), PartitionInfo(id=3, leader=4, replicas=[1, 2, 4, 5], isrs=[1, 2, 4, 5]), PartitionInfo(id=4, leader=2, replicas=[2, 3, 4, 5], isrs=[2, 3, 4, 5])]
[PartitionInfo(id=0, leader=6, replicas=[1, 2, 4, 6], isrs=[1, 2, 4, 6]), PartitionInfo(id=1, leader=1, replicas=[1, 2, 4, 5], isrs=[1, 2, 4, 5]), PartitionInfo(id=2, leader=4, replicas=[2, 3, 4, 5], isrs=[2, 3, 4, 5]), PartitionInfo(id=3, leader=2, replicas=[2, 3, 5, 6], isrs=[2, 3, 5, 6]), PartitionInfo(id=4, leader=5, replicas=[1, 3, 5, 6], isrs=[1, 3, 5, 6]), PartitionInfo(id=5, leader=3, replicas=[1, 3, 4, 6], isrs=[1, 3, 4, 6]), PartitionInfo(id=6, leader=6, replicas=[2, 3, 5, 6], isrs=[2, 3, 5, 6]), PartitionInfo(id=7, leader=1, replicas=[1, 3, 5, 6], isrs=[1, 3, 5, 6]), PartitionInfo(id=8, leader=4, replicas=[1, 3, 4, 6], isrs=[1, 3, 4, 6])]
[PartitionInfo(id=0, leader=3, replicas=[1, 3, 4, 6], isrs=[1, 3, 4, 6]), PartitionInfo(id=1, leader=6, replicas=[1, 2, 4, 6], isrs=[1, 2, 4, 6])]
[PartitionInfo(id=0, leader=5, replicas=[1, 2, 4, 5], isrs=[1, 2, 4, 5]), PartitionInfo(id=1, leader=3, replicas=[2, 3, 4, 5], isrs=[2, 3, 4, 5]), PartitionInfo(id=2, leader=6, replicas=[2, 3, 5, 6], isrs=[2, 3, 5, 6])]
    */
