...
/opensource/kafka_2.13-3.1.0/bin/kafka-topics.sh --bootstrap-server=${BOOTSTRAP_SERVER} --create --topic greg-test1 --partitions 6 --replication-factor 4 --config min.insync.replicas=3
#
