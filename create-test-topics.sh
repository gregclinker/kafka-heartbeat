...
/opensource/kafka_2.13-3.1.0/bin/kafka-topics.sh --bootstrap-server=${BOOTSTRAP_SERVER} --create --topic greg-test1 --partitions 5 --replication-factor 2 --config min.insync.replicas=2
#
